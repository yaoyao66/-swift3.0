...
class OrderPayWayViewController: BaseViewController {
    ...
    fileprivate func buildCouponView() {
        ...
        checkButton.setTitle("查看", for: UIControlState())
        checkButton.setTitleColor(UIColor.black, for: UIControlState())
    ...
    fileprivate func buildCarefullyView() {
        ...
        payButton.setTitle("确认付款", for: UIControlState())
        payButton.backgroundColor = LFBNavigationYellowColor
        payButton.setTitleColor(UIColor.black, for: UIControlState())
