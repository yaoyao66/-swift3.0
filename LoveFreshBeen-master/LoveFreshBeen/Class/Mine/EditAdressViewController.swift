...
class EditAdressViewController: BaseViewController {
    ...
    fileprivate func buildNavigationItem() {
        ...
        let rightItemButton = UIBarButtonItem.barButton("保存", titleColor: UIColor.lightGray, target: self, action: #selector(EditAdressViewController.saveButtonClick))
    ...
    fileprivate func buildInputView() -> UIView {
        ...
        cancleButton.tag = 10
        cancleButton.addTarget(self, action: #selector(EditAdressViewController.selectedCityTextFieldDidChange(_:)), for: .touchUpInside)
        ...
        determineButton.addTarget(self, action: #selector(EditAdressViewController.selectedCityTextFieldDidChange(_:)), for: .touchUpInside)
    ...
    fileprivate func buildGenderButton(_ button: LeftImageRightTextButton, frame: CGRect, title: String, tag: Int) {
        ...
        button.addTarget(self, action: #selector(EditAdressViewController.genderButtonClick(_:)), for: .touchUpInside)
